...
The mean of total number of steps taken per day is `r totalMean`. The median is `r totalMedian`.
...
The interval with the highest mean total steps is `r maxInterval`.
...
```
The mean of total number of steps taken per day, while imputing missing values, is `r totalMeanEdited`. The median is `r totalMedianEdited`.  
